...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<String, Malware> malwareDB = XMLParser.parse("firewall_malwareDB.xml");
        MalwareScanner scanner = new MalwareScanner(malwareDB);
        scanner.scanFile("firewall_captured.txt");
        ...
        int maxNumberOfAvailableAUAVs = Util.readNumberOfAvailableAUAVs("exterminate_input_2.dat");
